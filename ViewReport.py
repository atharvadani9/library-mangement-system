...
def Report():
    ...
    labelFrame1.place(relx=0.1,rely=0.2,relwidth=0.8,relheight=0.08)

    # Student ID
    lb1 = Label(labelFrame1,text="Student ID : ", bg='black', fg='white')
    lb1.place(relx=0.05,rely=0.25, relheight=0.35)
        
    bookInfo10 = Entry(labelFrame1)
    bookInfo10.place(relx=0.3,rely=0.25, relwidth=0.62, relheight=0.35)
    ...
    Label(labelFrame2, text="%-15s%-15s%-15s%-15s%-15s%-10s"%('SID','BID','Issue Date','Return Date','Due Date','Money Due'),bg='black',fg='white', font='Courier').place(relx=0.03,rely=0.1)
    ...
    SubmitBtn.place(relx=0.2,rely=0.3, relwidth=0.18,relheight=0.08)

    quitBtn = Button(root,text="Quit",bg='#f7f1e3', fg='black', command=root.destroy)
    quitBtn.place(relx=0.6,rely=0.3, relwidth=0.18,relheight=0.08)
